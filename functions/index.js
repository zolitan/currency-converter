...
app.get(
  ['/convert/reference_date/:reference_date/src_currency/:src_currency/amount/:amount/dest_currency/:dest_currency',
    '/convert/:reference_date/:src_currency/:amount/:dest_currency'],
  async (req, res, next) => {
